...
class ConfigurableExpansionTileState extends State<ConfigurableExpansionTile> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _iconTurns =
        _controller.drive((widget.animatedWidgetTurnTween ?? ConfigurableExpansionTile._halfTween).chain(widget.animatedWidgetTween ?? ConfigurableExpansionTile._easeInTween));
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: closed ? null : widget.childrenBody ?? Container(color: widget.expandedBackgroundColor ?? Colors.transparent, child: SizedBox()),
    );
  }
}
